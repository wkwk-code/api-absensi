...
describe('uses_cases/authentication', () => {
  ...
  beforeEach(() => {
    ...
    adminUserRepo.getUserByEmail = jest.fn();
  ...
  describe('creating a cookie', () => {
    it('should return a cookie', async () => {
      ...
      expect(await loginUseCases.getCookieWithJwtToken('email')).toEqual(
    ...
    it('should return a refresh cookie', async () => {
      ...
      expect(await loginUseCases.getCookieWithJwtRefreshToken('email')).toEqual(
  ...
  describe('validation local strategy', () => {
    it('should return null because user not found', async () => {
      (adminUserRepo.getUserByEmail as jest.Mock).mockReturnValue(Promise.resolve(null));

      expect(await loginUseCases.validateUserForLocalStragtegy('email', 'password')).toEqual(null);
    });
    it('should return null because wrong password', async () => {
      ...
      (adminUserRepo.getUserByEmail as jest.Mock).mockReturnValue(Promise.resolve(user));
    ...
    it('should return user without password', async () => {
      ...
      expect(await loginUseCases.validateUserForLocalStragtegy('email', 'password')).toEqual(rest);
    });
  });
  ...
  describe('Validation jwt strategy', () => {
    it('should return null because user not found', async () => {
      ...
      expect(await loginUseCases.validateUserForJWTStragtegy('email')).toEqual(null);
    });
    ...
    it('should return user', async () => {
      ...
      expect(await loginUseCases.validateUserForJWTStragtegy('email')).toEqual(user);
    });
  });
  ...
  describe('Validation refresh token', () => {
    it('should return null because user not found', async () => {
      ...
      expect(await loginUseCases.getUserIfRefreshTokenMatches('refresh token', 'email')).toEqual(null);
    });
    ...
    it('should return user', async () => {
      ...
      expect(await loginUseCases.getUserIfRefreshTokenMatches('refresh token', 'email')).toEqual(user);
    });
  });
  ...
  describe('isAuthenticated', () => {
    it('should return an array to invalid the cookie', async () => {
      ...
      expect(await isAuthenticated.execute('email')).toEqual(rest);
    });
  });
});